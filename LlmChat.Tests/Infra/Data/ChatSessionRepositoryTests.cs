...
namespace LlmChat.Tests.Infra.Data;
...
public class ChatSessionRepositoryTests
{
    ...
    public void Setup()
    {
        ...
        _repository = new ChatSessionRepository(_dbContext, _loggingService);
    }
    ...
    public async Task GetSessionAsync_WithExistingSession_ReturnsSession()
    {
        ...
        // Act
        var result = await _repository.GetSessionAsync(sessionId);
    ...
    public async Task SaveSessionAsync_CreatesNewSession()
    {
        ...
        // Act
        await _repository.SaveSessionAsync(sessionId, content);
    ...
    public async Task UpdateSessionAsync_WithExistingSession_UpdatesSession()
    {
        ...
        // Act
        await _repository.UpdateSessionAsync(sessionId, "new content");
    ...
    public async Task UpdateSessionAsync_WithNonExistingSession_ThrowsException()
    {
        ...
        await Assert.ThrowsExceptionAsync<InvalidOperationException>(() => 
            _repository.UpdateSessionAsync(sessionId, "new content"));
